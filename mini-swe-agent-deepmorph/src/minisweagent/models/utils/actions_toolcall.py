...
def parse_toolcall_actions(tool_calls: list, *, format_error_template: str) -> list[dict]:
    ...
    for tool_call in tool_calls:
        ...
        if tool_call.function.name == "graph_query" and isinstance(args, dict):
            action = _parse_graph_query_action(args, tool_call.id)
        ...
        if tool_call.function.name == "graph_query":
