...
class LitellmModelConfig(BaseModel):
    ...
    """Additional tool schemas to expose to the model."""
    response_api_tool_schemas: list[dict[str, Any]] = []
    """Additional Responses API tool schemas to expose to the model."""
    ...
    def _query(self, messages: list[dict[str, str]], **kwargs):
        try:
            return litellm.completion(
                ...
                messages=messages,
                tools=[BASH_TOOL, *self.config.tool_schemas],
